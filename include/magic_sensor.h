...
class MAGIC_EXPORT_API SensorController final : public NonCopyable {
  ...
  using PointCloud2Ptr = std::shared_ptr<PointCloud2>;          // 3D Lidar data pointer
  ...
  using PointCloud2Callback = std::function<void(const PointCloud2Ptr)>;
